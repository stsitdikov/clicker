...
const double kDefaultAutoClickNumber = 0;
...
const double kDefaultWorkerNumber = 0;
const double kDefaultWorkerIncrement = 1;
const double kDefaultStartWorkerAnimation = 0;
const double kDefaultWorkerVisible = 0;
...
const double kDefaultManagerNumber = 0;
const double kDefaultManagerIncrement = 1;
const double kDefaultStartManagerAnimation = 0;
const double kDefaultManagerVisible = 0;
